...
namespace Ecliptix.Feature.Authentication.Authentication.ViewModels.SignIn;

public sealed partial class SignInViewModel : Core.Core.MVVM.ViewModelBase, IRoutableViewModel, IResettable, IDisposable
{
