...
namespace Ecliptix.Feature.Authentication.Authentication.Infrastructure;
    ...
    : IAuthRepository
{
    ...
    public Task<Result<Membership, string>> VerifyRegistrationOtpAsync(
        Guid sessionIdentifier,
        string otpCode,
        uint connectId,
        CancellationToken cancellationToken = default) =>
    ...
    public Task<Result<Membership, string>> VerifySecureKeyResetOtpAsync(
        Guid sessionIdentifier,
        string otpCode,
        uint connectId,
        CancellationToken cancellationToken = default) =>
