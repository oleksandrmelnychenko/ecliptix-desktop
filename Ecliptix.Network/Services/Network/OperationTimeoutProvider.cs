...
public sealed class OperationTimeoutProvider : IOperationTimeoutProvider
{
    ...
    private static readonly FrozenDictionary<RpcServiceType, TimeSpan> ServiceTimeouts =
        new Dictionary<RpcServiceType, TimeSpan>
        {
            ...
            [RpcServiceType.RecoveryInit] = Timeout.InfiniteTimeSpan,
            [RpcServiceType.RecoveryComplete] = Timeout.InfiniteTimeSpan,
    ...
    private static readonly FrozenDictionary<RpcServiceType, TimeSpan> ServiceTimeouts =
        new Dictionary<RpcServiceType, TimeSpan>
        {
            ...
            [RpcServiceType.RecoveryInit] = TimeSpan.FromSeconds(45),
            [RpcServiceType.RecoveryComplete] = TimeSpan.FromSeconds(45),
