...
using Ecliptix.Feature.Settings.Settings.Domain.Models;
...
public sealed partial class SettingsViewModel : Core.Core.MVVM.ViewModelBase, IActivatableViewModel
{
