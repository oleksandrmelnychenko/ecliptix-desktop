...
public partial class HintedTextBox : UserControl
{
    ...
    public HintedTextBox()
    {
        ...
        if (_mainTextBox != null && focusBorder != null)
        {
            // Subscribe to text changes for inline validation
            _mainTextBox.TextChanged += (s, e) =>
            {
                ...
                UpdateBorderState(_mainTextBox, focusBorder, _mainTextBox.IsFocused);
            };

            _mainTextBox.GotFocus += (s, e) =>
            {
                UpdateBorderState(_mainTextBox, focusBorder, true);
            };

            _mainTextBox.LostFocus += (s, e) =>
            {
                UpdateBorderState(_mainTextBox, focusBorder);
            };
    ...
    private void UpdateBorderState(TextBox mainTextBox, Border focusBorder, bool forceFocus = false)
    {
        ...
        else
        {
            ...
            mainBorder.BorderBrush = new SolidColorBrush(Color.Parse("#808080"));
        }
    }
