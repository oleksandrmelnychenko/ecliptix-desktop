...
public static class LocalizationData
{
    public static readonly FrozenDictionary<string, string> EnglishStrings = new Dictionary<string, string>
    {
        ...
        [LocalizationKeys.Authentication.Error.MEMBERSHIP_IDENTIFIER_REQUIRED] = "Membership identifier is required",
        [LocalizationKeys.Authentication.Error.SESSION_EXPIRED] = "Your session has expired. Please start the registration process again.",
        [LocalizationKeys.Authentication.Error.REGISTRATION_INCOMPLETE] = "Registration data is incomplete. Please restart the registration process.",

        [LocalizationKeys.Common.SERVER_UNAVAILABLE] = "Server is currently unavailable. Please try again later.",
        [LocalizationKeys.Authentication.SignUp.MobileVerification.TITLE] = "Create Account",
        [LocalizationKeys.Authentication.SignUp.MobileVerification.DESCRIPTION] = "Confirm your number. We'll text you a verification code.",
        [LocalizationKeys.Authentication.SignUp.MobileVerification.HINT] = "Include country code",
        [LocalizationKeys.Authentication.SignUp.MobileVerification.WATERMARK] = "Mobile Number",
        [LocalizationKeys.Authentication.SignUp.MobileVerification.BUTTON] = "Continue",

        [LocalizationKeys.Authentication.SecureKeyRecovery.MobileVerification.TITLE] = "Reset Secure Key",
        [LocalizationKeys.Authentication.SecureKeyRecovery.MobileVerification.DESCRIPTION] = "Enter your mobile number to receive a verification code.",
        [LocalizationKeys.Authentication.SecureKeyRecovery.MobileVerification.HINT] = "Include country code",
        [LocalizationKeys.Authentication.SecureKeyRecovery.MobileVerification.WATERMARK] = "Mobile Number",
        [LocalizationKeys.Authentication.SecureKeyRecovery.MobileVerification.BUTTON] = "Continue",

        [LocalizationKeys.Authentication.SignUp.VerificationCodeEntry.TITLE] = "Verify Your Number",
        [LocalizationKeys.Authentication.SignUp.VerificationCodeEntry.DESCRIPTION] = "Enter the code sent to your mobile.",
        [LocalizationKeys.Authentication.SignUp.VerificationCodeEntry.HINT] = "Verification Code",
        [LocalizationKeys.Authentication.SignUp.VerificationCodeEntry.ERROR_INVALID_CODE] = "Invalid code. Please try again.",
        ...
        [LocalizationKeys.Authentication.SignUp.SecureKeyConfirmation.DESCRIPTION] = "Use a strong, unique secure key for security.",
        [LocalizationKeys.Authentication.SignUp.SecureKeyConfirmation.SECURE_KEY_PLACEHOLDER] = "Secure Key",
        [LocalizationKeys.Authentication.SignUp.SecureKeyConfirmation.SECURE_KEY_HINT] = "8 chars, 1 upper and 1 number",
        [LocalizationKeys.Authentication.SignUp.SecureKeyConfirmation.VERIFY_SECURE_KEY_PLACEHOLDER] = "Confirm Secure Key",
        [LocalizationKeys.Authentication.SignUp.SecureKeyConfirmation.VERIFY_SECURE_KEY_HINT] = "Re-enter the secure key to confirm",
        [LocalizationKeys.Authentication.SignUp.SecureKeyConfirmation.ERROR_SECURE_KEY_MISMATCH] = "Secure keys do not match.",
        ...
        [LocalizationKeys.Authentication.SecureKeyRecovery.Reset.DESCRIPTION] = "Create a new secure key for your account.",
        [LocalizationKeys.Authentication.SecureKeyRecovery.Reset.NEW_SECURE_KEY_PLACEHOLDER] = "New Secure Key",
        [LocalizationKeys.Authentication.SecureKeyRecovery.Reset.NEW_SECURE_KEY_HINT] = "8 chars, 1 upper and 1 number",
        [LocalizationKeys.Authentication.SecureKeyRecovery.Reset.CONFIRM_SECURE_KEY_PLACEHOLDER] = "Confirm New Key",
        [LocalizationKeys.Authentication.SecureKeyRecovery.Reset.CONFIRM_SECURE_KEY_HINT] = "Re-enter your new secure key",
        ...
        [LocalizationKeys.Authentication.SignIn.WELCOME] = "Welcome back! Let's get you back to your secure, personalized workspace.",
        ...
        [LocalizationKeys.MobileVerification.Error.MOBILE_ALREADY_REGISTERED] = "A problem occurred with your registration. If you already have an account, please try logging in or use the account recovery option.",
        [LocalizationKeys.MobileVerification.AVAILABLE_FOR_REGISTRATION] = "This mobile number is available for registration.",
        [LocalizationKeys.MobileVerification.INCOMPLETE_REGISTRATION_CONTINUE] = "Continue your registration with this mobile number.",
        [LocalizationKeys.MobileVerification.TAKEN_ACTIVE_ACCOUNT] = "This mobile number is already registered with an active account. Please sign in instead.",
        [LocalizationKeys.MobileVerification.TAKEN_INACTIVE_ACCOUNT] = "This mobile number is registered but inactive. Please use secure key recovery to regain access.",
        [LocalizationKeys.MobileVerification.DATA_CORRUPTION_CONTACT_SUPPORT] = "There's an issue with your account data. Please contact support for assistance.",
        [LocalizationKeys.MobileVerification.AVAILABLE_ON_THIS_DEVICE] = "This mobile number is available for registration on this device.",
        ...
        [LocalizationKeys.Verification.Error.GLOBAL_RATE_LIMIT_EXCEEDED] = "Too many requests. Please try again later",
        ...
        [LocalizationKeys.ResponseErrors.MobileNumber.ACCOUNT_ALREADY_REGISTERED] = "Account on this number already registered. Try sign in or use forgot secure key.",
        [LocalizationKeys.ResponseErrors.MobileNumber.UNEXPECTED_MEMBERSHIP_STATUS] = "Unexpected membership status. Please try again.",
        ...
        [LocalizationKeys.ValidationErrors.MobileNumberIdentifier.REQUIRED] = "Mobile number identifier is required",
        ...
        [LocalizationKeys.ValidationWarnings.SecureKey.MULTIPLE_CHARACTERS] = "Multiple instances of character type",
        ...
        [LocalizationKeys.NetworkNotification.RetriesExhausted.DESCRIPTION] = "Unable to connect after multiple attempts",
    ...
    public static readonly FrozenDictionary<string, string> UkrainianStrings = new Dictionary<string, string>
    {
        ...
        [LocalizationKeys.Authentication.Error.MEMBERSHIP_IDENTIFIER_REQUIRED] = "Ідентифікатор учасника є обов'язковим",
        [LocalizationKeys.Authentication.Error.SESSION_EXPIRED] = "Ваша сесія закінчилася. Будь ласка, почніть реєстрацію спочатку.",
        [LocalizationKeys.Authentication.Error.REGISTRATION_INCOMPLETE] = "Дані реєстрації неповні. Будь ласка, почніть процес реєстрації знову.",

        [LocalizationKeys.Authentication.SignUp.MobileVerification.TITLE] = "Створити акаунт",
        [LocalizationKeys.Authentication.SignUp.MobileVerification.DESCRIPTION] = "Підтвердьте номер. Ми надішлемо код в SMS.",
        [LocalizationKeys.Authentication.SignUp.MobileVerification.HINT] = "Включно з кодом країни",
        [LocalizationKeys.Authentication.SignUp.MobileVerification.WATERMARK] = "Номер мобільного",
        [LocalizationKeys.Authentication.SignUp.MobileVerification.BUTTON] = "Продовжити",

        [LocalizationKeys.Authentication.SecureKeyRecovery.MobileVerification.TITLE] = "Скинути ключ безпеки",
        [LocalizationKeys.Authentication.SecureKeyRecovery.MobileVerification.DESCRIPTION] = "Підтвердьте номер для отримання коду підтвердження.",
        [LocalizationKeys.Authentication.SecureKeyRecovery.MobileVerification.HINT] = "Включно з кодом країни",
        [LocalizationKeys.Authentication.SecureKeyRecovery.MobileVerification.WATERMARK] = "Номер мобільного",
        [LocalizationKeys.Authentication.SecureKeyRecovery.MobileVerification.BUTTON] = "Продовжити",

        [LocalizationKeys.Authentication.SignUp.VerificationCodeEntry.TITLE] = "Підтвердження номера",
        [LocalizationKeys.Authentication.SignUp.VerificationCodeEntry.DESCRIPTION] = "Введіть код, надісланий на ваш мобільний.",
        [LocalizationKeys.Authentication.SignUp.VerificationCodeEntry.HINT] = "Код підтвердження",
        [LocalizationKeys.Authentication.SignUp.VerificationCodeEntry.ERROR_INVALID_CODE] = "Неправильний код. Спробуйте ще раз.",
        ...
        [LocalizationKeys.Authentication.SignUp.SecureKeyConfirmation.DESCRIPTION] = "Для безпеки використовуйте надійний ключ безпеки.",
        [LocalizationKeys.Authentication.SignUp.SecureKeyConfirmation.SECURE_KEY_PLACEHOLDER] = "Ключ безпеки",
        [LocalizationKeys.Authentication.SignUp.SecureKeyConfirmation.SECURE_KEY_HINT] = "8 символів, 1 велика літера та 1 цифра",
        [LocalizationKeys.Authentication.SignUp.SecureKeyConfirmation.VERIFY_SECURE_KEY_PLACEHOLDER] = "Повторіть ключ",
        [LocalizationKeys.Authentication.SignUp.SecureKeyConfirmation.VERIFY_SECURE_KEY_HINT] = "Введіть ключ ще раз для підтвердження",
        [LocalizationKeys.Authentication.SignUp.SecureKeyConfirmation.ERROR_SECURE_KEY_MISMATCH] = "Ключі безпеки не збігаються.",
        ...
        [LocalizationKeys.Authentication.SecureKeyRecovery.Reset.DESCRIPTION] = "Створіть новий ключ безпеки для облікового запису.",
        [LocalizationKeys.Authentication.SecureKeyRecovery.Reset.NEW_SECURE_KEY_PLACEHOLDER] = "Новий ключ безпеки",
        [LocalizationKeys.Authentication.SecureKeyRecovery.Reset.NEW_SECURE_KEY_HINT] = "8 символів, 1 велика літера та 1 цифра",
        [LocalizationKeys.Authentication.SecureKeyRecovery.Reset.CONFIRM_SECURE_KEY_PLACEHOLDER] = "Підтвердіть новий ключ",
        [LocalizationKeys.Authentication.SecureKeyRecovery.Reset.CONFIRM_SECURE_KEY_HINT] = "Введіть новий ключ ще раз",
        ...
        [LocalizationKeys.MobileVerification.Error.MOBILE_ALREADY_REGISTERED] = "Під час реєстрації сталася помилка. Якщо у вас вже є акаунт, будь ласка, спробуйте увійти або скористайтеся опцією відновлення доступу.",
        [LocalizationKeys.MobileVerification.AVAILABLE_FOR_REGISTRATION] = "Цей номер доступний для реєстрації.",
        [LocalizationKeys.MobileVerification.INCOMPLETE_REGISTRATION_CONTINUE] = "Продовжіть реєстрацію з цим номером.",
        [LocalizationKeys.MobileVerification.TAKEN_ACTIVE_ACCOUNT] = "Цей номер вже зареєстровано з активним акаунтом. Будь ласка, увійдіть.",
        [LocalizationKeys.MobileVerification.TAKEN_INACTIVE_ACCOUNT] = "Цей номер зареєстровано, але акаунт неактивний. Скористайтеся відновленням ключа безпеки.",
        [LocalizationKeys.MobileVerification.DATA_CORRUPTION_CONTACT_SUPPORT] = "Виникла проблема з даними вашого акаунта. Будь ласка, зверніться до підтримки.",
        [LocalizationKeys.MobileVerification.AVAILABLE_ON_THIS_DEVICE] = "Цей номер доступний для реєстрації на цьому пристрої.",
        ...
        [LocalizationKeys.Verification.Error.MAX_ATTEMPTS_REACHED] = "Досягнуто максимальну кількість спроб підтвердження",
        ...
        [LocalizationKeys.Verification.Error.GLOBAL_RATE_LIMIT_EXCEEDED] = "Занадто багато запитів. Спробуйте пізніше",
        ...
        [LocalizationKeys.ValidationErrors.MobileNumberIdentifier.REQUIRED] = "Ідентифікатор номера мобільного телефону є обов'язковим",
        ...
        [LocalizationKeys.ResponseErrors.MobileNumber.ACCOUNT_ALREADY_REGISTERED] = "Акаунт з цим номером вже зареєстровано. Спробуйте увійти або скористайтеся відновленням пароля.",
        [LocalizationKeys.ResponseErrors.MobileNumber.UNEXPECTED_MEMBERSHIP_STATUS] = "Неочікуваний статус системи. Спробуйте ще раз.",
        [LocalizationKeys.ResponseErrors.Common.TIMEOUT_EXCEEDED] = "Операція перевищила час очікування. Спробуйте ще раз.",
        ...
        [LocalizationKeys.Footer.AGREEMENT_TEXT] = "Продовжуючи, ви погоджуєтесь з нашими Умовами та Політикою конфіденційності.",
        ...
        [LocalizationKeys.NetworkNotification.CheckingInternet.DESCRIPTION] = "Перевіряємо підключення до інтернету",
        ...
        [LocalizationKeys.NetworkNotification.Reconnecting.DESCRIPTION] = "Намагаємось відновити з'єднання з сервером",
        ...
        [LocalizationKeys.NetworkNotification.RetriesExhausted.DESCRIPTION] = "Неможливо підключитись після кількох спроб",
