...
public static class LocalizationData
{
    public static readonly FrozenDictionary<string, string> EnglishStrings = new Dictionary<string, string>
    {
        ...
        [LocalizationKeys.Authentication.SignUp.VerificationCodeEntry.WRONG_NUMBER] = "Wrong number?",
        [LocalizationKeys.Authentication.SignUp.VerificationCodeEntry.CHANGE_NUMBER] = "Change Number",
    ...
    private static readonly FrozenDictionary<string, string> UkrainianStrings = new Dictionary<string, string>
    {
        ...
        [LocalizationKeys.Authentication.SignUp.VerificationCodeEntry.WRONG_NUMBER] = "Невірний номер?",
        [LocalizationKeys.Authentication.SignUp.VerificationCodeEntry.CHANGE_NUMBER] = "Змінити Номер",
