...
public static class LocalizationData
{
    public static readonly FrozenDictionary<string, string> EnglishStrings = new Dictionary<string, string>
    {
        ...
        ["Authentication.SignUp.SecureKeyConfirmation.SecureKeyPlaceholder"] = "Secure Key",
        ["Authentication.SignUp.SecureKeyConfirmation.SecureKeyHint"] = "8 chars, 1 upper and 1 number",
        ["Authentication.SignUp.SecureKeyConfirmation.VerifySecureKeyPlaceholder"] = "Confirm Secure Key",
        ["Authentication.SignUp.SecureKeyConfirmation.VerifySecureKeyHint"] = "Re-enter the secure key to confirm",
        ...
        ["Authentication.SignIn.SecureKeyPlaceholder"] = "Secure Key",
        ["Authentication.SignIn.SecureKeyHint"] = "Stored only on this device",
    ...
    public static readonly FrozenDictionary<string, string> UkrainianStrings = new Dictionary<string, string>
    {
        ...
        ["Authentication.SignUp.SecureKeyConfirmation.SecureKeyPlaceholder"] = "Ключ безпеки",
        ["Authentication.SignUp.SecureKeyConfirmation.SecureKeyHint"] = "8 символів, 1 велика літера та 1 цифра",
        ["Authentication.SignUp.SecureKeyConfirmation.VerifySecureKeyPlaceholder"] = "Повторіть ключ",
        ["Authentication.SignUp.SecureKeyConfirmation.VerifySecureKeyHint"] = "Введіть ключ ще раз для підтвердження",
        ...
        ["Authentication.SignIn.SecureKeyPlaceholder"] = "Ключ безпеки",
        ["Authentication.SignIn.SecureKeyHint"] = "Зберігається лише на цьому пристрої",
