...
public static class LocalizationData
{
    public static readonly FrozenDictionary<string, string> EnglishStrings = new Dictionary<string, string>
    {
        ...
        [LocalizationKeys.Authentication.WelcomeBack.ERROR_SESSION_MISSING] = "Session data missing. Please sign in again.",
    ...
    private static readonly FrozenDictionary<string, string> UkrainianStrings = new Dictionary<string, string>
    {
        ...
        [LocalizationKeys.Authentication.WelcomeBack.ERROR_SESSION_MISSING] = "Дані сесії відсутні. Будь ласка, увійдіть знову.",
