...
public static class LocalizationData
{
    public static readonly FrozenDictionary<string, string> EnglishStrings = new Dictionary<string, string>
    {
        ...
        ["Authentication.SignUp.VerificationCodeEntry.Expiration"] = "Code expires in: {0}",
        ...
        ["ValidationErrors.SecureKey.TooSimple"] = "Too simple",
    ...
    public static readonly FrozenDictionary<string, string> UkrainianStrings = new Dictionary<string, string>
    {
        ...
        ["Authentication.SignUp.VerificationCodeEntry.Expiration"] = "Код дійсний: {0}",
        ...
        ["ValidationErrors.SecureKey.TooSimple"] = "Занадто простий",
